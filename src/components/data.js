...
export const initialTickets = [
  {
    ...
    description: "Customer is unable to log in to their account. They've tried resetting the password multiple times, but it still fails.",
    customer: "John Smith",
  ...
  },
  {
    ...
    description: "Customer attempted to pay using Visa ending 1234 but the payment is always failing despite sufficient funds.",
  ...
  },
  {
    ...
    description: "Customer wants to enable auto-renewal for their subscription but the option isn't there.",
    customer: "Liam Thomsen",
    priority: "MEDIUM PRIORITY",
    status: "In-Progress",
    createdAt: "1/27/2024",
  },
  {
    ...
    description: "Customer placed an order but didn't receive a confirmation email. Not showing up even in spam.",
